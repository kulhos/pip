 ...
 ; 
 ;DO NOT MODIFY  Screen OOE functions|FORMDQ2C|||||||1
FORMDQ2C(SID) ; 
 ;
 N OP N pgm
 ;
...
DIREFDFT(fid,di) ; Column name
 ...
 S RM(2)=$$YN($P(colrec,"|",29))_"|3" ; Required flag
 S RM(3)=$P(colrec,"|",6)_"            |4" ; Display format
 I ($P(colrec,"|",30)>0) S RM(4)=$P(colrec,"|",30)
 E  S RM(4)=$P(colrec,"|",7)
 S RM(4)=RM(4)_"|5" ; Length
 ;
 I '($P(colrec,"|",24)="") D  ; Pre-proc
 .	;
 .	S EDI(1)=1
 .	S RM(5)=$$YN(1)_"|6"
 .	;
 .	S Z3=$order(PP(""),-1)+1
 .	S PP(Z3,1)=" "_$P(colrec,"|",24)
 .	;
 .	Q 
 E  S RM(5)=$$YN(0)_"|6"
 ;
 I '($P(colrec,"|",23)="") D  ; Post proc
 .	;
 .	S EDI(2)=1
 .	S RM(6)=$$YN(1)_"|7"
 .	;
 .	S Z1=$order(PP(""),-1)+1
 .	S PP(Z1,1)=" "_$P(colrec,"|",23)
 .	Q 
 E  S RM(6)=$$YN(0)_"|7"
 ;
 S RM(7)=$P(colrec,"|",25)
 ...
 S Z=Z_dl_$P(colrec,"|",6)_dl_$P(colrec,"|",21)_dl_dl_Z2
 S Z=Z_dl_$P(colrec,"|",22)_dl_$P(colrec,"|",27)_dl_$P(colrec,"|",28)
 ;
 S $piece(Z,dl,7)=$P(colrec,"|",29)
 S $piece(Z,dl,18)=$P(colrec,"|",6)
 ;
 I '($P(colrec,"|",23)="") S $piece(Z,dl,14)=Z1
 I '($P(colrec,"|",24)="") S $piece(Z,dl,13)=Z3
 ;
 I '($P(colrec,"|",4)="") D
 .	;
...
EXIT(SID) ; Screen ID
 ...
 .	;
 .	N zdbtbl2,vop1,vop2,vop3 S vop1="SYSDEV",vop2=SID,zdbtbl2=$$vRCgetRecord0Opt^RecordDBTBL2("SYSDEV",SID,0,"")
 ...
 .	;
 .	N dbtbl2,vop4,vop5,vop6 S vop4="SYSDEV",vop5=OSID,dbtbl2=$$vRCgetRecord0Opt^RecordDBTBL2("SYSDEV",OSID,0,"")
...
vSIG() ; 
 Q "^^^7958" ; Signature - LTD^TIME^USER^SIZE
 ; ----------------
