%ZM	;LIBRARY;Data-Type Format masks
	...
	;
	;	     Replaced all other $$UPPER calls as well.
	;
	; 07/15/06 - RussellDS - CR22121
	;	     Move routine into application space as of V7.0 to support
	;	     changes necessary for Unicode.
	;
	;	     Modified FLOG section to replace use of $A and $C for
	;	     upper case with calls to $$UPPER^SCAUTL for Unicode
	;	     compliance.
	;
	;	     Removed old revison history.
	;
	;----------------------------------------------------------------------
