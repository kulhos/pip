...
ARCHIVE(ARCHTBL,THRUDATE,SELECT,FROM,WHERE)	; 
	...
	.	I '($E($TR(SELECT,"abcdefghijklmnopqrstuvwxyz","ABCDEFGHIJKLMNOPQRSTUVWXYZ"),1,8)="DISTINCT") S SELECT="DISTINCT "_SELECT
	.	;
...
vL1a3	S vos3=$O(^DBARCHIS(vos2,vos3),1) I vos3="" G vL1a6
	S vos4=$S('$D(vos4):vos3,vos4<vos3:vos3,1:vos4)
	G vL1a3
vL1a6	I $G(vos4)=""  G vL1a0
	Q
	;
vFetch1()	; 
	;
