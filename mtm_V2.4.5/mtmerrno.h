...
*   $Id$
*   $Log:	mtmerrno.h,v $
 * Revision 2.4  07/02/12  thoniyim ()
 * Added the error message MTM_STATS_RUNNING to notify that
 * MTM Stats is already running.
 *
 * Revision 2.3  05/12/06  paulj ()
 * Added the error message MTM_NO_STATS to indicates that
 * MTM Stats is not on.Added notification messages 
 * MTM_STATS_ON,MTM_STATS_OFF and MTM_GETSTAT
 *
 * Revision 2.2  00/03/27  16:09:07  16:09:07  lyh ()
 * wogm release
 * 
 * Revision 2.1  00/01/17  11:18:01  11:18:01  lyh ()
 * storm trooper release
 * 
 * Revision 1.1  99/12/28  11:14:02  11:14:02  lyh ()
 * Initial revision
 * 
...
#define MTM_SENDMSG				-41
#define MTM_GETVER				-42
#define MTM_GETPARAM				-43
#define MTM_SVCLEAN				-44
#define MTM_CLIENT_ASYNC_TABLE_ERROR		-45

#define MTM_NO_STATS				-46
#define MTM_STATS_ON				-47
#define MTM_STATS_OFF				-48
#define MTM_GETSTAT				-49
#define MTM_STATS_RUNNING			-50
