 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordSVSTATZ ****
 ; 
 ; 02/24/2010 18:41 - pip
 ; 
 ;
 ; Record Class code for table SVSTATZ
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordSVSTATZ",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
...
vRCgetRecord0(v1,v2,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordSVSTATZ"
 S vobj(vOid)=$G(^SVSTAT(v1,v2))
 I vobj(vOid)="",'($D(^SVSTAT(v1,v2))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,SVSTATZ",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 ;*** End of code by-passed by compiler ***
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=SCOPE
...
vRCgetRecord0Opt(v1,v2,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S svstatz=$G(^SVSTAT(v1,v2))
 I svstatz="",'($D(^SVSTAT(v1,v2))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,SVSTATZ",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q svstatz
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","SRVTYP"))&($P($E($G(vobj(this,-100,"1*","SRVTYP")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","SRVID"))&($P($E($G(vobj(this,-100,"2*","SRVID")),5,9999),$C(124))'=vobj(this,-4))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
 ...
 .	Q 
 E  I (%O=3) D
 .	  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) Q:'($D(^SVSTAT(V1,V2))#2) 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,svstatz,vkey1,vkey2) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("SRVID,SRVTYP,SVSTATZ",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N svstatz S svstatz=$$vRCgetRecord0^RecordSVSTATZ(SRVTYP,SRVID,0)
 .	S vobj(svstatz,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordSVSTATZ(svstatz,$$initPar^UCUTILN(params)) K vobj(svstatz,-100) S vobj(svstatz,-2)=1 TC:vTp  
 .	K vobj(+$G(svstatz)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCmiscValidations(this,vRCparams,processMode) ; 
 I (("/"_vRCparams_"/")["/VALST/")  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) I '(''($D(^SVSTAT(V1,V2))#2)=''processMode) D
 .	N errmsg
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^SVSTAT(vobj(this,-3),vobj(this,-4))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^SVSTAT(vobj(this,-3),vobj(this,-4))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCsetDefaults(this) ; 
...
vRCchkReqForInsert(this) ; 
 ...
 I ($P(vobj(this),$C(124),1)="") D vRCrequiredErr("SVSTATZ")
 Q 
 ;
vRCchkReqForUpdate(this) ; 
 I (vobj(this,-3)="") D vRCrequiredErr("SRVTYP")
 I (vobj(this,-4)="") D vRCrequiredErr("SRVID")
 I ($D(vobj(this,-100,"0*","SVSTATZ"))&($P($E($G(vobj(this,-100,"0*","SVSTATZ")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))),($P(vobj(this),$C(124),1)="") D vRCrequiredErr("SVSTATZ")
 Q 
 ;
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("SVSTATZ","MSG",1767,"SVSTATZ."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 I '(($P(vobj(this),$C(124),1)=1)!($P(vobj(this),$C(124),1)=0)) D vRCvalidateDDerr("SVSTATZ",$$^MSG(742,"L"))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"0*","SVSTATZ"))&($P($E($G(vobj(this,-100,"0*","SVSTATZ")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))) I '(($P(vobj(this),$C(124),1)=1)!($P(vobj(this),$C(124),1)=0)) D vRCvalidateDDerr("SVSTATZ",$$^MSG(742,"L"))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("SVSTATZ","MSG",979,"SVSTATZ."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey2 S oldKey2=$S($D(vobj(this,-100,"2*","SRVID")):$P($E(vobj(this,-100,"2*","SRVID"),5,9999),$C(124)),1:vobj(this,-4))
  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) I ($D(^SVSTAT(V1,V2))#2) D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordSVSTATZ(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("SVSTATZ",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vCa2(v1,v2out) ; voXN = ({Cache}%CACHE("CTBLSVTYP").getRecord(CTBLSVTYP,1)
 ...
 ;
vReCp1(v1) ; RecordSVSTATZ.copy: SVSTATZ
 ;
 Q $$copy^UCGMR(this)
