 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordTMPERR9 ****
 ; 
 ; 02/24/2010 18:41 - pip
 ; 
 ;
 ; Record Class code for table TMPERR9
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordTMPERR9",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
...
vRCgetRecord0(v1,v2,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordTMPERR9"
 S vobj(vOid)=$G(^TMP(v1,v2))
 I vobj(vOid)="",'($D(^TMP(v1,v2))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,TMPERR9",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 ;*** End of code by-passed by compiler ***
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=SCOPE
...
vRCgetRecord0Opt(v1,v2,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S tmperr9=$G(^TMP(v1,v2))
 I tmperr9="",'($D(^TMP(v1,v2))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,TMPERR9",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q tmperr9
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","JOB"))&($P($E($G(vobj(this,-100,"1*","JOB")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","VAR"))&($P($E($G(vobj(this,-100,"2*","VAR")),5,9999),$C(124))'=vobj(this,-4))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,tmperr9,vkey1,vkey2) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("JOB,VAL,VAR",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N tmperr9 S tmperr9=$$vRCgetRecord0^RecordTMPERR9(JOB,VAR,0)
 .	S vobj(tmperr9,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordTMPERR9(tmperr9,$$initPar^UCUTILN(params)) K vobj(tmperr9,-100) S vobj(tmperr9,-2)=1 TC:vTp  
 .	K vobj(+$G(tmperr9)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCchkReqForInsert(this) ; 
 I (vobj(this,-3)="") D vRCrequiredErr("JOB")
 I (vobj(this,-4)="") D vRCrequiredErr("VAR")
 Q 
 ;
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("TMPERR9","MSG",1767,"TMPERR9."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 S X=vobj(this,-3) I '(X=""),(X'?1.12N),(X'?1"-"1.11N) D vRCvalidateDDerr("JOB",$$^MSG(742,"N"))
 I ($L(vobj(this,-4))>50) D vRCvalidateDDerr("VAR",$$^MSG(1076,50))
 I ($L($P(vobj(this),$C(124),1))>400) D vRCvalidateDDerr("VAL",$$^MSG(1076,400))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 N RM S RM=""
 N errmsg N X
 I ($D(vobj(this,-100,"1*","JOB"))&($P($E($G(vobj(this,-100,"1*","JOB")),5,9999),$C(124))'=vobj(this,-3))),'(vobj(this,-3)=""),'(+vobj(this,-3)=vobj(this,-3))  S vobj(this,-3)=$$vRCtrimNumber(vobj(this,-3))
 I ($D(vobj(this,-100,"1*","JOB"))&($P($E($G(vobj(this,-100,"1*","JOB")),5,9999),$C(124))'=vobj(this,-3))) S X=vobj(this,-3) I '(X=""),(X'?1.12N),(X'?1"-"1.11N) D vRCvalidateDDerr("JOB",$$^MSG(742,"N"))
 I ($D(vobj(this,-100,"2*","VAR"))&($P($E($G(vobj(this,-100,"2*","VAR")),5,9999),$C(124))'=vobj(this,-4))) I ($L(vobj(this,-4))>50) D vRCvalidateDDerr("VAR",$$^MSG(1076,50))
 I ($D(vobj(this,-100,"0*","VAL"))&($P($E($G(vobj(this,-100,"0*","VAL")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))) I ($L($P(vobj(this),$C(124),1))>400) D vRCvalidateDDerr("VAL",$$^MSG(1076,400))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("TMPERR9","MSG",979,"TMPERR9."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey1 S oldKey1=$S($D(vobj(this,-100,"1*","JOB")):$P($E(vobj(this,-100,"1*","JOB"),5,9999),$C(124)),1:vobj(this,-3))
 N newKey2 S newKey2=vobj(this,-4)
 N oldKey2 S oldKey2=$S($D(vobj(this,-100,"2*","VAR")):$P($E(vobj(this,-100,"2*","VAR"),5,9999),$C(124)),1:vobj(this,-4))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordTMPERR9(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("TMPERR9",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vReCp1(v1) ; RecordTMPERR9.copy: TMPERR9
 ;
 Q $$copy^UCGMR(this)
