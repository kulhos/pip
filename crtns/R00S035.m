...
VHDG3 ; Group Header
 ...
 D VOM
 S VL="                            "_"Access File:"
 S VL=VL_" "_$E(vc11,1,12)
 D VOM
 S VL="                       "_"SQL Where Clause:"
 S VL=VL_" "_$E(vc12,1,90)
 D VOM
 S VL="                    "_"SQL Distinct Clause:"
 S VL=VL_" "_$E(vc13,1,40)
 D VOM
 S VL="               "_"Multiple Time Zone logic:"
 S VL=VL_" "_$S(vc14:"Y",1:"N")
 D VOM
 S VL="                   "_"Insert Restart Logic:"
 S VL=VL_" "_$S(vc15:"Y",1:"N")
 D VOM
 S VL="------------------------------------------------------------------------------------------------------------------------------------"
 D VOM
 Q 
...
VP1 ; Column pre-processor - Variable: zcode
 ...
 S SEQ=vc4
 ;
 N dbtbl33d S dbtbl33d=$$vRCgetRecord0Opt^RecordDBTBL33D("SYSDEV",BCHID,LABEL,SEQ,0,"")
 ;
