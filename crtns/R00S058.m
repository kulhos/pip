...
V0 ; External report entry point
 ...
 N rwrs,vos1,vos2,sqlcur,exe,sqlcur,vd,vi,vsql,vsub S rwrs=$$vOpen0(.exe,.vsql,"DBTBL7.%LIBS,DBTBL7.TABLE,DBTBL7.TRGID,DBTBL7.DES,DBTBL7.ACTBI,DBTBL7.ACTAI,DBTBL7.ACTBU,DBTBL7.ACTAU,DBTBL7.ACTBD,DBTBL7.ACTAD,DBTBL7.TLD,DBTBL7.USER,DBTBL7.COLUMNS","DBTBL7",VWHERE,"DBTBL7.%LIBS,DBTBL7.TABLE,DBTBL7.TRGID","","/DQMODE=1",1)
 ;  #ACCEPT Date=10/13/2008;Pgm=RussellDS;CR=35741;Group=READ
...
VP2 ; Column pre-processor - Variable: ZSYSGEN
 ;
 S ZSYSGEN=" type public Record"_vc2_" "_$ZCONVERT(vc2,"L")
 ;
 Q 
 ;
VP3 ; Column pre-processor - Variable: ZSETAUD
 ...
 S ZSETAUD=" do "_$ZCONVERT(vc2,"L")_".setAuditFlag(1)"
 ;
 Q 
 ;
...
vFetch1() ;
 ...
 I vos1=0 S rs="" Q 0
 ;
 S vos6=$G(^DBTBL("SYSDEV",7,vos3,vos4,vos5))
 S rs=$P(vos6,$C(1),1)
 ;
 Q 1
 ;
