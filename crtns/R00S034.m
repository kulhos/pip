...
V0 ; External report entry point
 ...
 N rwrs,vos1,vos2,sqlcur,exe,sqlcur,vd,vi,vsql,vsub S rwrs=$$vOpen0(.exe,.vsql,"DBINDX.LIBS,DBINDX.DBOPT,DBINDX.FID,DBINDX.DINAM,DBINDX.INDEXID,DBINDX.FLDESC,DBINDX.DIDESC,DBINDX.IDNAME,DBINDX.OPTDESC","DBINDX",VWHERE,"DBINDX.LIBS,DBINDX.DBOPT,DBINDX.FID,DBINDX.DINAM,DBINDX.INDEXID","","/DQMODE=1",1)
 ;  #ACCEPT Date=10/13/2008;Pgm=RussellDS;CR=35741;Group=READ
