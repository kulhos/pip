 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBAUDITLOGD ****
 ; 
 ; 02/24/2010 18:39 - pip
 ; 
 ;
 ; Record Class code for table DBAUDITLOGD
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBAUDITLOGD",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
 S vobj(vOid,-5)=""
 S vobj(vOid,-6)=""
...
vRCgetRecord0(v1,v2,v3,v4,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBAUDITLOGD"
 S vobj(vOid)=$G(^DBAUDITLOG(v1,v2,v3,v4))
 I vobj(vOid)="",'$D(^DBAUDITLOG(v1,v2,v3,v4))
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBAUDITLOGD",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 S vobj(vOid,-6)=v4
...
vRCgetRecord0Opt(v1,v2,v3,v4,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S dbauditlogd=$G(^DBAUDITLOG(v1,v2,v3,v4))
 I dbauditlogd="",'$D(^DBAUDITLOG(v1,v2,v3,v4))
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBAUDITLOGD",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbauditlogd
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","CDATE"))&($P($E($G(vobj(this,-100,"1*","CDATE")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","PID"))&($P($E($G(vobj(this,-100,"2*","PID")),5,9999),$C(124))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","SEQ"))&($P($E($G(vobj(this,-100,"3*","SEQ")),5,9999),$C(124))'=vobj(this,-5)))!($D(vobj(this,-100,"4*","RECSEQ"))&($P($E($G(vobj(this,-100,"4*","RECSEQ")),5,9999),$C(124))'=vobj(this,-6))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
 ...
 .	Q 
 E  I (%O=3) D
 .	  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) Q:'($D(^DBAUDITLOG(V1,V2,V3,V4))) 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbauditlogd,vkey1,vkey2,vkey3,vkey4) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("CDATE,KEYS,PID,RECSEQ,SEQ",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
columnListCMP() ; 
 Q $$vStrRep("BIDATA",",",$char(9),0,0,"")
 ;
getColumnMap(map) ; 
 ;
 S map(-6)="RECSEQ:N:"
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbauditlogd S dbauditlogd=$$vRCgetRecord0^RecordDBAUDITLOGD(CDATE,PID,SEQ,RECSEQ,0)
 .	S vobj(dbauditlogd,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBAUDITLOGD(dbauditlogd,$$initPar^UCUTILN(params)) K vobj(dbauditlogd,-100) S vobj(dbauditlogd,-2)=1 TC:vTp  
 .	K vobj(+$G(dbauditlogd)) Q 
 Q 
 ;
vhasLiterals() ; 
 Q 0
...
vRCmiscValidations(this,vRCparams,processMode) ; 
 I (("/"_vRCparams_"/")["/VALST/")  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I '(''($D(^DBAUDITLOG(V1,V2,V3,V4)))=''processMode) D
 .	N errmsg
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 ..		;*** Start of code by-passed by compiler
 ..		S ^DBAUDITLOG(vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6),n)=vobj(this,n)
 ..		;*** End of code by-passed by compiler ***
 ..		Q 
 .	;   #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; GROUP=BYPASS
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBAUDITLOG(vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ...
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 kill ^DBAUDITLOG(vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCchkReqForInsert(this) ; 
 ...
 I (vobj(this,-6)="") D vRCrequiredErr("RECSEQ")
...
vRCchkReqForUpdate(this) ; 
 ...
 ; Node "4*" - only one required column
 I ($D(vobj(this,-100,"4*","RECSEQ"))&($P($E($G(vobj(this,-100,"4*","RECSEQ")),5,9999),$C(124))'=vobj(this,-6))),(vobj(this,-6)="") D vRCrequiredErr("RECSEQ")
 Q 
 ;
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBAUDITLOGD","MSG",1767,"DBAUDITLOGD."_column)
...
vRCforceLoad(this) ; 
 ...
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 for  set n=$order(^DBAUDITLOG(vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6),n)) quit:n=""  if '$D(vobj(this,n)),$D(^DBAUDITLOG(vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6),n))#2 set vobj(this,n)=^(n)
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCvalidateDD(this,processMode) ; 
 ...
 S X=vobj(this,-6) I '(X=""),(X'?1.12N),(X'?1"-"1.11N) D vRCvalidateDDerr("RECSEQ",$$^MSG(742,"N"))
 I ($D(vobj(this))#2)!'($order(vobj(this,""))="") D
 .	I ($L($P(vobj(this),$C(124),1))>80) D vRCvalidateDDerr("KEYS",$$^MSG(1076,80))
 .	Q 
 Q 
 ;
vRCvalidateDD1(this) ; 
 ...
 I ($D(vobj(this,-100,"4*","RECSEQ"))&($P($E($G(vobj(this,-100,"4*","RECSEQ")),5,9999),$C(124))'=vobj(this,-6))),'(vobj(this,-6)=""),'(+vobj(this,-6)=vobj(this,-6))  S vobj(this,-6)=$$vRCtrimNumber(vobj(this,-6))
 I ($D(vobj(this,-100,"4*","RECSEQ"))&($P($E($G(vobj(this,-100,"4*","RECSEQ")),5,9999),$C(124))'=vobj(this,-6))) S X=vobj(this,-6) I '(X=""),(X'?1.12N),(X'?1"-"1.11N) D vRCvalidateDDerr("RECSEQ",$$^MSG(742,"N"))
 I ($D(vobj(this))#2)!'($order(vobj(this,""))="") D
 .	I ($D(vobj(this,-100,"0*","KEYS"))&($P($E($G(vobj(this,-100,"0*","KEYS")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))) I ($L($P(vobj(this),$C(124),1))>80) D vRCvalidateDDerr("KEYS",$$^MSG(1076,80))
 .	Q 
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBAUDITLOGD","MSG",979,"DBAUDITLOGD."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey4 S oldKey4=$S($D(vobj(this,-100,"4*","RECSEQ")):$P($E(vobj(this,-100,"4*","RECSEQ"),5,9999),$C(124)),1:vobj(this,-6))
  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I ($D(^DBAUDITLOG(V1,V2,V3,V4))) D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBAUDITLOGD(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBAUDITLOGD",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vReCp1(v1) ; RecordDBAUDITLOGD.copy: DBAUDITLOGD
 ;
 N vNod,vOid
 I $G(vobj(v1,-2)) D
