 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordSYSMAPLITDTA ****
 ; 
 ; 02/24/2010 18:41 - pip
 ; 
 ;
 ; Record Class code for table SYSMAPLITDTA
 ;
...
vRCgetRecord0(v1,v2,v3,v4,vfromDbSet) ; 
 ...
 I vobj(vOid)="",'($D(^SYSMAP("LITDATA",v1,v2,v3,v4))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,SYSMAPLITDTA",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 S vobj(vOid,-6)=v4
...
vRCgetRecord0Opt(v1,v2,v3,v4,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S sysmaplitdta=$G(^SYSMAP("LITDATA",v1,v2,v3,v4))
 I sysmaplitdta="",'($D(^SYSMAP("LITDATA",v1,v2,v3,v4))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,SYSMAPLITDTA",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q sysmaplitdta
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","TARGET"))&($P($E($G(vobj(this,-100,"1*","TARGET")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","TABLE"))&($P($E($G(vobj(this,-100,"2*","TABLE")),5,9999),$C(124))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","COLUMN"))&($P($E($G(vobj(this,-100,"3*","COLUMN")),5,9999),$C(124))'=vobj(this,-5)))!($D(vobj(this,-100,"4*","FUNC"))&($P($E($G(vobj(this,-100,"4*","FUNC")),5,9999),$C(124))'=vobj(this,-6))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
 ...
 .	Q 
 E  I (%O=3) D
 .	  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) Q:'($D(^SYSMAP("LITDATA",V1,V2,V3,V4))#2) 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,sysmaplitdta,vkey1,vkey2,vkey3,vkey4) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("COLUMN,FUNC,TABLE,TARGET",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N sysmaplitdta S sysmaplitdta=$$vRCgetRecord0^RecordSYSMAPLITDTA(TARGET,TABLE,COLUMN,FUNC,0)
 .	S vobj(sysmaplitdta,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordSYSMAPLITDTA(sysmaplitdta,$$initPar^UCUTILN(params)) K vobj(sysmaplitdta,-100) S vobj(sysmaplitdta,-2)=1 TC:vTp  
...
vRCmiscValidations(this,vRCparams,processMode) ; 
 I (("/"_vRCparams_"/")["/VALST/")  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I '(''($D(^SYSMAP("LITDATA",V1,V2,V3,V4))#2)=''processMode) D
 .	N errmsg
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^SYSMAP("LITDATA",vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^SYSMAP("LITDATA",vobj(this,-3),vobj(this,-4),vobj(this,-5),vobj(this,-6))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCchkReqForInsert(this) ; 
 I (vobj(this,-5)="") D vRCrequiredErr("COLUMN")
 I (vobj(this,-6)="") D vRCrequiredErr("FUNC")
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("SYSMAPLITDTA","MSG",1767,"SYSMAPLITDTA."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 I ($L(vobj(this,-5))>25) D vRCvalidateDDerr("COLUMN",$$^MSG(1076,25))
 I ($L(vobj(this,-6))>63) D vRCvalidateDDerr("FUNC",$$^MSG(1076,63))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"3*","COLUMN"))&($P($E($G(vobj(this,-100,"3*","COLUMN")),5,9999),$C(124))'=vobj(this,-5))) I ($L(vobj(this,-5))>25) D vRCvalidateDDerr("COLUMN",$$^MSG(1076,25))
 I ($D(vobj(this,-100,"4*","FUNC"))&($P($E($G(vobj(this,-100,"4*","FUNC")),5,9999),$C(124))'=vobj(this,-6))) I ($L(vobj(this,-6))>63) D vRCvalidateDDerr("FUNC",$$^MSG(1076,63))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("SYSMAPLITDTA","MSG",979,"SYSMAPLITDTA."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey3 S oldKey3=$S($D(vobj(this,-100,"3*","COLUMN")):$P($E(vobj(this,-100,"3*","COLUMN"),5,9999),$C(124)),1:vobj(this,-5))
 N newKey4 S newKey4=vobj(this,-6)
 N oldKey4 S oldKey4=$S($D(vobj(this,-100,"4*","FUNC")):$P($E(vobj(this,-100,"4*","FUNC"),5,9999),$C(124)),1:vobj(this,-6))
  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I ($D(^SYSMAP("LITDATA",V1,V2,V3,V4))#2) D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordSYSMAPLITDTA(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("SYSMAPLITDTA",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
