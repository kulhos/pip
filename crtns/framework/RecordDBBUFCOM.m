...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("BUFFER,BUFREC,TOKEN",",",$char(9),0,0,"")
 ;
columnListBM() ; 
...
vRCvalidateDD1(this) ; 
 ...
 I ($D(vobj(this,-100,"3*","BUFREC"))&($P($E($G(vobj(this,-100,"3*","BUFREC")),5,9999),$C(124))'=vobj(this,-5))),'(vobj(this,-5)=""),'(+vobj(this,-5)=vobj(this,-5))  S vobj(this,-5)=$$vRCtrimNumber(vobj(this,-5))
 I ($D(vobj(this,-100,"3*","BUFREC"))&($P($E($G(vobj(this,-100,"3*","BUFREC")),5,9999),$C(124))'=vobj(this,-5))) S X=vobj(this,-5) I '(X=""),(X'?1.2N),(X'?1"-"1.1N) D vRCvalidateDDerr("BUFREC",$$^MSG(742,"N"))
 Q 
 ;
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey3 S oldKey3=$S($D(vobj(this,-100,"3*","BUFREC")):$P($E(vobj(this,-100,"3*","BUFREC"),5,9999),$C(124)),1:vobj(this,-5))
  N V1,V2,V3 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5) I ($D(^DBBUF(V1,V2,V3))#2) D throwError($$^MSG(2327))
...
vReCp1(v1) ; RecordDBBUFCOM.copy: DBBUFCOM
 ...
 N vNod,vOid
 I $G(vobj(v1,-2)) D
 . N von,vol S von="",vol=$D(vobj(v1,1,1)) S:'vol vobj(v1,1,1)="" F  Q:vol  S von=$O(^DBBUF(vobj(v1,-3),vobj(v1,-4),vobj(v1,-5),von)) quit:von=""  S vobj(v1,1,1)=vobj(v1,1,1)_^DBBUF(vobj(v1,-3),vobj(v1,-4),vobj(v1,-5),von)
