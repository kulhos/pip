...
vRCvalidateDD(this,processMode) ; 
 ...
 I ($L($P(vobj(this),$C(12),1))>250) D vRCvalidateDDerr("CODE",$$^MSG(1076,250))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"0*","CODE"))&($P($E($G(vobj(this,-100,"0*","CODE")),5,9999),$C(12))'=$P(vobj(this),$C(12),1))) I ($L($P(vobj(this),$C(12),1))>250) D vRCvalidateDDerr("CODE",$$^MSG(1076,250))
 Q 
 ;
