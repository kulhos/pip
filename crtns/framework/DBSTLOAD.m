...
BUILD(FID,Q) ; Query string built in other routines  /NOREQ
 ...
 S SPLITFLG=0
 ;
 N collist,vos1,vos2,vos3,vos4,vos5,vos6,vos7 S collist=$$vOpen1()
 S vpc='$G(vos1) Q:vpc 
 ...
 S vpc='$G(vobj(rs,0)) K:vpc vobj(+$G(rs)) Q:vpc 
 ;
...
vFetch1() ;
 ...
 ;
 S vos7=$G(^DBTBL("SYSDEV",1,vos3,9,vos6))
 S collist=$S(vos4=vos2:"",1:vos4)_$C(9)_$P(vos7,"|",9)_$C(9)_$S(vos6=vos2:"",1:vos6)_$C(9)_$P(vos7,"|",16)
 ;
 Q 1
 ;
vCatch1 ; Error trap
