 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL4 ****
 ; 
 ; 02/24/2010 18:40 - pip
 ; 
 ;
 ; Record Class code for table DBTBL4
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL4",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
...
vRCgetRecord0(v1,v2,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL4"
 S vobj(vOid)=$G(^DBTBL(v1,4,v2))
 I vobj(vOid)="",'$D(^DBTBL(v1,4,v2))
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL4",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 ;*** End of code by-passed by compiler ***
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=SCOPE
...
vRCgetRecord0Opt(v1,v2,vfromDbSet,v2out) ; 
 ...
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL4",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl4
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","LIBS"))&($P($E($G(vobj(this,-100,"1*","LIBS")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","QID"))&($P($E($G(vobj(this,-100,"2*","QID")),5,9999),$C(124))'=vobj(this,-4))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
 ...
 .	Q 
 E  I (%O=3) D
 .	  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) Q:'($D(^DBTBL(V1,4,V2))) 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl4,vkey1,vkey2) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("DATE,DESC,LIBS,PFID,QID,UID,VERSION",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
getColumnMap(map) ; 
 ...
 S map(-3)="LIBS:T:"
 S map(-1)="DESC:T:1"
 S map(0)="DATE:D:3;PFID:T:1;UID:T:15;VERSION:T:4"
 Q 
 ;
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl4 S dbtbl4=$$vRCgetRecord0^RecordDBTBL4(LIBS,QID,0)
 .	S vobj(dbtbl4,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL4(dbtbl4,$$initPar^UCUTILN(params)) K vobj(dbtbl4,-100) S vobj(dbtbl4,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl4)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCmiscValidations(this,vRCparams,processMode) ; 
 I (("/"_vRCparams_"/")["/VALST/")  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) I '(''($D(^DBTBL(V1,4,V2)))=''processMode) D
 .	N errmsg
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
  S:'$D(vobj(this,0)) vobj(this,0)=$S(vobj(this,-2):$G(^DBTBL(vobj(this,-3),4,vobj(this,-4),0)),1:"")
 I '(("/"_vRCparams_"/")["/NOUPDATE/") D
 .  S vobj(this,-100,0)="" S $P(vobj(this,0),$C(124),3)=$P($H,",",1)
 .	I '(+$P($G(vobj(this,-100,0,"UID")),$C(124),2)&($P($E($G(vobj(this,-100,0,"UID")),5,9999),$C(124))'=$P(vobj(this,0),$C(124),15)))  S vobj(this,-100,0)="" S $P(vobj(this,0),$C(124),15)=$E($$USERNAM^%ZFUNC,1,16)
 .	N n
 .	S n=-1
 ...
 ..		;*** Start of code by-passed by compiler
 ..		S ^DBTBL(vobj(this,-3),4,vobj(this,-4),n)=vobj(this,n)
 ..		;*** End of code by-passed by compiler ***
 ..		Q 
 .	;   #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; GROUP=BYPASS
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBTBL(vobj(this,-3),4,vobj(this,-4))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ...
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 kill ^DBTBL(vobj(this,-3),4,vobj(this,-4))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCsetDefaults(this) ; 
 ...
 I ($P(vobj(this,0),$C(124),4)="")  S vobj(this,-100,0)="" S $P(vobj(this,0),$C(124),4)="V2.0"
 Q 
 ;
...
vRCchkReqForUpdate(this) ; 
 ...
 I ($D(vobj(this,-100,"2*","QID"))&($P($E($G(vobj(this,-100,"2*","QID")),5,9999),$C(124))'=vobj(this,-4))),(vobj(this,-4)="") D vRCrequiredErr("QID")
 Q 
 ;
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL4","MSG",1767,"DBTBL4."_column)
...
vRCforceLoad(this) ; 
 ...
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 for  set n=$order(^DBTBL(vobj(this,-3),4,vobj(this,-4),n)) quit:n=""  if '$D(vobj(this,n)),$D(^DBTBL(vobj(this,-3),4,vobj(this,-4),n))#2 set vobj(this,n)=^(n)
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCvalidateDD(this,processMode) ; 
 ...
 .	I ($L($P(vobj(this,0),$C(124),15))>16) D vRCvalidateDDerr("UID",$$^MSG(1076,16))
 .	I ($L($P(vobj(this,0),$C(124),4))>4) D vRCvalidateDDerr("VERSION",$$^MSG(1076,4))
 .	Q 
...
vRCvalidateDD1(this) ; 
 ...
 .	I ($D(vobj(this,-100,0,"UID"))&($P($E($G(vobj(this,-100,0,"UID")),5,9999),$C(124))'=$P(vobj(this,0),$C(124),15))) I ($L($P(vobj(this,0),$C(124),15))>16) D vRCvalidateDDerr("UID",$$^MSG(1076,16))
 .	I ($D(vobj(this,-100,0,"VERSION"))&($P($E($G(vobj(this,-100,0,"VERSION")),5,9999),$C(124))'=$P(vobj(this,0),$C(124),4))) I ($L($P(vobj(this,0),$C(124),4))>4) D vRCvalidateDDerr("VERSION",$$^MSG(1076,4))
 .	Q 
...
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL4","MSG",979,"DBTBL4."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey2 S oldKey2=$S($D(vobj(this,-100,"2*","QID")):$P($E(vobj(this,-100,"2*","QID"),5,9999),$C(124)),1:vobj(this,-4))
  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) I ($D(^DBTBL(V1,4,V2))) D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL4(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL4",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vReCp1(v1) ; RecordDBTBL4.copy: DBTBL4
 ;
 N vNod,vOid
 I $G(vobj(v1,-2)) D
 .	F vNod=0 S:'$D(vobj(v1,vNod)) vobj(v1,vNod)=$G(^DBTBL(vobj(v1,-3),4,vobj(v1,-4),vNod))
