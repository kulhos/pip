 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL13LNK ****
 ; 
 ; 02/24/2010 18:39 - pip
 ; 
 ;
 ; Record Class code for table DBTBL13LNK
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL13LNK",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
 S vobj(vOid,-5)=""
 S vobj(vOid,-6)=""
...
vRCgetRecord0(v1,v2,v3,v4,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL13LNK"
 S vobj(vOid)=$G(^DBTBL(v1,13,v2,v3,v4))
 I '(v3<0)
 E  I vobj(vOid)="",'($D(^DBTBL(v1,13,v2,v3,v4))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL13LNK",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 S vobj(vOid,-6)=v4
...
vRCgetRecord0Opt(v1,v2,v3,v4,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S dbtbl13lnk=$G(^DBTBL(v1,13,v2,v3,v4))
 I '(v3<0)
 E  I dbtbl13lnk="",'($D(^DBTBL(v1,13,v2,v3,v4))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL13LNK",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl13lnk
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","LIBS"))&($P($E($G(vobj(this,-100,"1*","LIBS")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","PID"))&($P($E($G(vobj(this,-100,"2*","PID")),5,9999),$C(124))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","TYP"))&($P($E($G(vobj(this,-100,"3*","TYP")),5,9999),$C(124))'=vobj(this,-5)))!($D(vobj(this,-100,"4*","NAME"))&($P($E($G(vobj(this,-100,"4*","NAME")),5,9999),$C(124))'=vobj(this,-6))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl13lnk,vkey1,vkey2,vkey3,vkey4) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("LIBS,NAME,PID,TYP",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl13lnk S dbtbl13lnk=$$vRCgetRecord0^RecordDBTBL13LNK(LIBS,PID,TYP,NAME,0)
 .	S vobj(dbtbl13lnk,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL13LNK(dbtbl13lnk,$$initPar^UCUTILN(params)) K vobj(dbtbl13lnk,-100) S vobj(dbtbl13lnk,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl13lnk)) Q 
 Q 
 ;
vhasLiterals() ; 
 Q 0
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBTBL(vobj(this,-3),13,vobj(this,-4),vobj(this,-5),vobj(this,-6))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^DBTBL(vobj(this,-3),13,vobj(this,-4),vobj(this,-5),vobj(this,-6))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCchkReqForInsert(this) ; 
 I (vobj(this,-3)="") D vRCrequiredErr("LIBS")
 I (vobj(this,-6)="") D vRCrequiredErr("NAME")
 I (vobj(this,-4)="") D vRCrequiredErr("PID")
 I (vobj(this,-5)="") D vRCrequiredErr("TYP")
 Q 
 ;
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL13LNK","MSG",1767,"DBTBL13LNK."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 S X=vobj(this,-5) I '(X=""),(X'?1.12N),(X'?1"-"1.11N) D vRCvalidateDDerr("TYP",$$^MSG(742,"N"))
 I ($L(vobj(this,-6))>20) D vRCvalidateDDerr("NAME",$$^MSG(1076,20))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"3*","TYP"))&($P($E($G(vobj(this,-100,"3*","TYP")),5,9999),$C(124))'=vobj(this,-5))),'(vobj(this,-5)=""),'(+vobj(this,-5)=vobj(this,-5))  S vobj(this,-5)=$$vRCtrimNumber(vobj(this,-5))
 I ($D(vobj(this,-100,"3*","TYP"))&($P($E($G(vobj(this,-100,"3*","TYP")),5,9999),$C(124))'=vobj(this,-5))) S X=vobj(this,-5) I '(X=""),(X'?1.12N),(X'?1"-"1.11N) D vRCvalidateDDerr("TYP",$$^MSG(742,"N"))
 I ($D(vobj(this,-100,"4*","NAME"))&($P($E($G(vobj(this,-100,"4*","NAME")),5,9999),$C(124))'=vobj(this,-6))) I ($L(vobj(this,-6))>20) D vRCvalidateDDerr("NAME",$$^MSG(1076,20))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL13LNK","MSG",979,"DBTBL13LNK."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey3 S oldKey3=$S($D(vobj(this,-100,"3*","TYP")):$P($E(vobj(this,-100,"3*","TYP"),5,9999),$C(124)),1:vobj(this,-5))
 N newKey4 S newKey4=vobj(this,-6)
 N oldKey4 S oldKey4=$S($D(vobj(this,-100,"4*","NAME")):$P($E(vobj(this,-100,"4*","NAME"),5,9999),$C(124)),1:vobj(this,-6))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL13LNK(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL13LNK",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vDbEx1() ; min(1): DISTINCT LIBS,PID,TYP,NAME FROM DBTBL13LNK WHERE LIBS=:V1 and PID=:V2 and TYP=:V3 and NAME=:V4
 ;
 N vsql1
 ...
 ;
 I '(V3<0) Q 0
 I '($D(^DBTBL(V1,13,V2,V3,V4))#2) Q 0
 Q 1
 ;
vDbEx2() ; min(1): DISTINCT LIBS,PID,TYP,NAME FROM DBTBL13LNK WHERE LIBS=:V1 and PID=:V2 and TYP=:V3 and NAME=:V4
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
 ...
 Q 1
 ;
vDbEx3() ; min(1): DISTINCT LIBS,PID,TYP,NAME FROM DBTBL13LNK WHERE LIBS=:V1 and PID=:V2 and TYP=:V3 and NAME=:V4
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
 ...
 Q 1
 ;
vReCp1(v1) ; RecordDBTBL13LNK.copy: DBTBL13LNK
 ;
 Q $$copy^UCGMR(this)
