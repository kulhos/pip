 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL12 ****
 ; 
 ; 02/24/2010 18:39 - pip
 ; 
 ;
 ; Record Class code for table DBTBL12
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL12",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
 S vobj(vOid,-5)=""
 S vobj(vOid,-6)=""
...
vRCgetRecord0(v1,v2,v3,v4,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL12"
 S vobj(vOid)=$G(^DBTBL(v1,12,v2,v3,v4))
 I vobj(vOid)="",'($D(^DBTBL(v1,12,v2,v3,v4))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL12",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 S vobj(vOid,-6)=v4
...
vRCgetRecord0Opt(v1,v2,v3,v4,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S dbtbl12=$G(^DBTBL(v1,12,v2,v3,v4))
 I dbtbl12="",'($D(^DBTBL(v1,12,v2,v3,v4))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL12",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl12
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","%LIBS"))&($P($E($G(vobj(this,-100,"1*","%LIBS")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","FID"))&($P($E($G(vobj(this,-100,"2*","FID")),5,9999),$C(124))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","CODE"))&($P($E($G(vobj(this,-100,"3*","CODE")),5,9999),$C(124))'=vobj(this,-5)))!($D(vobj(this,-100,"4*","SEQ"))&($P($E($G(vobj(this,-100,"4*","SEQ")),5,9999),$C(124))'=vobj(this,-6))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
 ...
 .	Q 
 E  I (%O=3) D
 .	  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) Q:'($D(^DBTBL(V1,12,V2,V3,V4))#2) 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl12,vkey1,vkey2,vkey3,vkey4) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("%LIBS,CODE,DOC,FID,SEQ",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
columnListCMP() ; 
 Q $$vStrRep("FDESC,PROMPT,RECDESC",",",$char(9),0,0,"")
 ;
getColumnMap(map) ; 
 ;
 S map(-6)="SEQ:N:"
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl12 S dbtbl12=$$vRCgetRecord0^RecordDBTBL12(%LIBS,FID,CODE,SEQ,0)
 .	S vobj(dbtbl12,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL12(dbtbl12,$$initPar^UCUTILN(params)) K vobj(dbtbl12,-100) S vobj(dbtbl12,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl12)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCmiscValidations(this,vRCparams,processMode) ; 
 I (("/"_vRCparams_"/")["/VALST/")  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I '(''($D(^DBTBL(V1,12,V2,V3,V4))#2)=''processMode) D
 .	N errmsg
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBTBL(vobj(this,-3),12,vobj(this,-4),vobj(this,-5),vobj(this,-6))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ...
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^DBTBL(vobj(this,-3),12,vobj(this,-4),vobj(this,-5),vobj(this,-6))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCchkReqForInsert(this) ; 
 I (vobj(this,-3)="") D vRCrequiredErr("%LIBS")
 I (vobj(this,-5)="") D vRCrequiredErr("CODE")
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL12","MSG",1767,"DBTBL12."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 S X=vobj(this,-4) I '(X="") S errmsg=$$VAL^DBSVER("U",25,1,,"X?1A.AN!(X?1""%"".AN)") I '(errmsg="") D vRCvalidateDDerr("FID",$$^MSG(979,"DBTBL12.FID"_" "_errmsg))
 I ($L(vobj(this,-5))>12) D vRCvalidateDDerr("CODE",$$^MSG(1076,12))
 ...
 I ($L($P(vobj(this),$C(124),1))>80) D vRCvalidateDDerr("DOC",$$^MSG(1076,80))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"2*","FID"))&($P($E($G(vobj(this,-100,"2*","FID")),5,9999),$C(124))'=vobj(this,-4))) S X=vobj(this,-4) I '(X="") S errmsg=$$VAL^DBSVER("U",25,1,,"X?1A.AN!(X?1""%"".AN)") I '(errmsg="") D vRCvalidateDDerr("FID",$$^MSG(979,"DBTBL12.FID"_" "_errmsg))
 I ($D(vobj(this,-100,"3*","CODE"))&($P($E($G(vobj(this,-100,"3*","CODE")),5,9999),$C(124))'=vobj(this,-5))) I ($L(vobj(this,-5))>12) D vRCvalidateDDerr("CODE",$$^MSG(1076,12))
 ...
 I ($D(vobj(this,-100,"0*","DOC"))&($P($E($G(vobj(this,-100,"0*","DOC")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))) I ($L($P(vobj(this),$C(124),1))>80) D vRCvalidateDDerr("DOC",$$^MSG(1076,80))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL12","MSG",979,"DBTBL12."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey3 S oldKey3=$S($D(vobj(this,-100,"3*","CODE")):$P($E(vobj(this,-100,"3*","CODE"),5,9999),$C(124)),1:vobj(this,-5))
 ...
 N oldKey4 S oldKey4=$S($D(vobj(this,-100,"4*","SEQ")):$P($E(vobj(this,-100,"4*","SEQ"),5,9999),$C(124)),1:vobj(this,-6))
  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I ($D(^DBTBL(V1,12,V2,V3,V4))#2) D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL12(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL12",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vReCp1(v1) ; RecordDBTBL12.copy: DBTBL12
 ;
 Q $$copy^UCGMR(this)
