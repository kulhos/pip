 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL17 ****
 ; 
 ; 02/24/2010 18:39 - pip
 ; 
 ;
 ; Record Class code for table DBTBL17
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL17",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
 S vobj(vOid,-5)=""
...
vRCgetRecord0(v1,v2,v3,vfromDbSet) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL17"
 S vobj(vOid)=$G(^DBTBL(v1,17,v2,v3))
 I '(v3>0)
 E  I vobj(vOid)="",'($D(^DBTBL(v1,17,v2,v3))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL17",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 ;*** End of code by-passed by compiler ***
...
vRCgetRecord0Opt(v1,v2,v3,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S dbtbl17=$G(^DBTBL(v1,17,v2,v3))
 I '(v3>0)
 E  I dbtbl17="",'($D(^DBTBL(v1,17,v2,v3))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL17",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl17
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","%LIBS"))&($P($E($G(vobj(this,-100,"1*","%LIBS")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","EXPID"))&($P($E($G(vobj(this,-100,"2*","EXPID")),5,9999),$C(124))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","SEQ"))&($P($E($G(vobj(this,-100,"3*","SEQ")),5,9999),$C(124))'=vobj(this,-5))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl17,vkey1,vkey2,vkey3) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("%LIBS,DELFLG,DOC,EXPID,NAMES,SEQ,TYPE",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
getColumnMap(map) ; 
 ...
 S map(-4)="EXPID:U:"
 S map(-3)="%LIBS:U:"
 S map(-1)="DELFLG:L:3;DOC:L:4;NAMES:U:2;TYPE:U:1"
 Q 
 ;
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl17 S dbtbl17=$$vRCgetRecord0^RecordDBTBL17(%LIBS,EXPID,SEQ,0)
 .	S vobj(dbtbl17,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL17(dbtbl17,$$initPar^UCUTILN(params)) K vobj(dbtbl17,-100) S vobj(dbtbl17,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl17)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBTBL(vobj(this,-3),17,vobj(this,-4),vobj(this,-5))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^DBTBL(vobj(this,-3),17,vobj(this,-4),vobj(this,-5))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCsetDefaults(this) ; 
...
vRCchkReqForInsert(this) ; 
 ...
 I ($P(vobj(this),$C(124),3)="") D vRCrequiredErr("DELFLG")
 I ($P(vobj(this),$C(124),4)="") D vRCrequiredErr("DOC")
...
vRCchkReqForUpdate(this) ; 
 ...
 I (vobj(this,-4)="") D vRCrequiredErr("EXPID")
 I (vobj(this,-5)="") D vRCrequiredErr("SEQ")
 I ($D(vobj(this,-100,"0*","DELFLG"))&($P($E($G(vobj(this,-100,"0*","DELFLG")),5,9999),$C(124))'=$P(vobj(this),$C(124),3))),($P(vobj(this),$C(124),3)="") D vRCrequiredErr("DELFLG")
 I ($D(vobj(this,-100,"0*","DOC"))&($P($E($G(vobj(this,-100,"0*","DOC")),5,9999),$C(124))'=$P(vobj(this),$C(124),4))),($P(vobj(this),$C(124),4)="") D vRCrequiredErr("DOC")
 Q 
 ;
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL17","MSG",1767,"DBTBL17."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 I '(($P(vobj(this),$C(124),3)=1)!($P(vobj(this),$C(124),3)=0)) D vRCvalidateDDerr("DELFLG",$$^MSG(742,"L"))
 I '(($P(vobj(this),$C(124),4)=1)!($P(vobj(this),$C(124),4)=0)) D vRCvalidateDDerr("DOC",$$^MSG(742,"L"))
 I ($P(vobj(this),$C(124),2)'=$ZCONVERT($P(vobj(this),$C(124),2),"U")) D vRCvalidateDDerr("NAMES",$$^MSG(1476))
 I ($L($P(vobj(this),$C(124),2))>65) D vRCvalidateDDerr("NAMES",$$^MSG(1076,65))
 I ($P(vobj(this),$C(124),1)'=$ZCONVERT($P(vobj(this),$C(124),1),"U")) D vRCvalidateDDerr("TYPE",$$^MSG(1476))
 I ($L($P(vobj(this),$C(124),1))>10) D vRCvalidateDDerr("TYPE",$$^MSG(1076,10))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"0*","DELFLG"))&($P($E($G(vobj(this,-100,"0*","DELFLG")),5,9999),$C(124))'=$P(vobj(this),$C(124),3))) I '(($P(vobj(this),$C(124),3)=1)!($P(vobj(this),$C(124),3)=0)) D vRCvalidateDDerr("DELFLG",$$^MSG(742,"L"))
 I ($D(vobj(this,-100,"0*","DOC"))&($P($E($G(vobj(this,-100,"0*","DOC")),5,9999),$C(124))'=$P(vobj(this),$C(124),4))) I '(($P(vobj(this),$C(124),4)=1)!($P(vobj(this),$C(124),4)=0)) D vRCvalidateDDerr("DOC",$$^MSG(742,"L"))
 I ($P(vobj(this),$C(124),2)'=$ZCONVERT($P(vobj(this),$C(124),2),"U")) D vRCvalidateDDerr("NAMES",$$^MSG(1476))
 I ($D(vobj(this,-100,"0*","NAMES"))&($P($E($G(vobj(this,-100,"0*","NAMES")),5,9999),$C(124))'=$P(vobj(this),$C(124),2))) I ($L($P(vobj(this),$C(124),2))>65) D vRCvalidateDDerr("NAMES",$$^MSG(1076,65))
 I ($P(vobj(this),$C(124),1)'=$ZCONVERT($P(vobj(this),$C(124),1),"U")) D vRCvalidateDDerr("TYPE",$$^MSG(1476))
 I ($D(vobj(this,-100,"0*","TYPE"))&($P($E($G(vobj(this,-100,"0*","TYPE")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))) I ($L($P(vobj(this),$C(124),1))>10) D vRCvalidateDDerr("TYPE",$$^MSG(1076,10))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL17","MSG",979,"DBTBL17."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL17(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL17",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vDbEx1() ; min(1): DISTINCT %LIBS,EXPID,SEQ FROM DBTBL17 WHERE %LIBS=:V1 and EXPID=:V2 and SEQ=:V3
 ;
 N vsql1
 ...
 ;
 I '(V3>0) Q 0
 I '($D(^DBTBL(V1,17,V2,V3))#2) Q 0
 Q 1
 ;
vDbEx2() ; min(1): DISTINCT %LIBS,EXPID,SEQ FROM DBTBL17 WHERE %LIBS=:V1 and EXPID=:V2 and SEQ=:V3
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
 ...
 Q 1
 ;
vDbEx3() ; min(1): DISTINCT %LIBS,EXPID,SEQ FROM DBTBL17 WHERE %LIBS=:V1 and EXPID=:V2 and SEQ=:V3
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
 ...
 Q 1
 ;
vReCp1(v1) ; RecordDBTBL17.copy: DBTBL17
 ;
 Q $$copy^UCGMR(this)
