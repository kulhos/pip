 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL33D ****
 ; 
 ; 02/24/2010 18:40 - pip
 ; 
 ;
 ; Record Class code for table DBTBL33D
 ;
...
vRCgetRecord0(v1,v2,v3,v4,vfromDbSet) ; 
 ...
 I vobj(vOid)="",'($D(^DBTBL(v1,33,v2,v3,v4))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL33D",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 S vobj(vOid,-6)=v4
...
vRCgetRecord0Opt(v1,v2,v3,v4,vfromDbSet,v2out) ; 
 ...
 I dbtbl33d="",'($D(^DBTBL(v1,33,v2,v3,v4))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL33D",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl33d
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","%LIBS"))&($P($E($G(vobj(this,-100,"1*","%LIBS")),5,9999),$C(12))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","BCHID"))&($P($E($G(vobj(this,-100,"2*","BCHID")),5,9999),$C(12))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","LABEL"))&($P($E($G(vobj(this,-100,"3*","LABEL")),5,9999),$C(12))'=vobj(this,-5)))!($D(vobj(this,-100,"4*","SEQ"))&($P($E($G(vobj(this,-100,"4*","SEQ")),5,9999),$C(12))'=vobj(this,-6))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
 ...
 .	Q 
 E  I (%O=3) D
 .	  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) Q:'($D(^DBTBL(V1,33,V2,V3,V4))#2) 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl33d,vkey1,vkey2,vkey3,vkey4) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("%LIBS,BCHID,CODE,LABEL,SEQ",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl33d S dbtbl33d=$$vRCgetRecord0^RecordDBTBL33D(%LIBS,BCHID,LABEL,SEQ,0)
 .	S vobj(dbtbl33d,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL33D(dbtbl33d,$$initPar^UCUTILN(params)) K vobj(dbtbl33d,-100) S vobj(dbtbl33d,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl33d)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCmiscValidations(this,vRCparams,processMode) ; 
 I (("/"_vRCparams_"/")["/VALST/")  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I '(''($D(^DBTBL(V1,33,V2,V3,V4))#2)=''processMode) D
 .	N errmsg
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBTBL(vobj(this,-3),33,vobj(this,-4),vobj(this,-5),vobj(this,-6))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ...
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^DBTBL(vobj(this,-3),33,vobj(this,-4),vobj(this,-5),vobj(this,-6))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCchkReqForInsert(this) ; 
 ...
 I (vobj(this,-5)="") D vRCrequiredErr("LABEL")
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL33D","MSG",1767,"DBTBL33D."_column)
 I ER D throwError($get(RM))
 Q 
 ;
vRCsetForeignKeys(this) ; 
 I '(vobj(this,-4)="") S vfkey("^DBTBL("_""""_vobj(this,-3)_""""_","_33_","_""""_vobj(this,-4)_""""_")")="DBTBL33D(%LIBS,BCHID) -> DBTBL33"
 Q 
 ;
vRCcheckForeignKeys(this) ; 
  N V1,V2 S V1=vobj(this,-3),V2=vobj(this,-4) I '($D(^DBTBL(V1,33,V2))#2) D throwError($$^MSG(8563,"DBTBL33D(%LIBS,BCHID) -> DBTBL33"))
 Q 
 ;
vRCvalidateDD(this,processMode) ; 
 ...
 I (vobj(this,-5)'=$ZCONVERT(vobj(this,-5),"U")) D vRCvalidateDDerr("LABEL",$$^MSG(1476))
 I ($L(vobj(this,-5))>12) D vRCvalidateDDerr("LABEL",$$^MSG(1076,12))
 ...
 I ($L($P(vobj(this),$C(12),1))>255) D vRCvalidateDDerr("CODE",$$^MSG(1076,255))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I (vobj(this,-4)'=$ZCONVERT(vobj(this,-4),"U")) D vRCvalidateDDerr("BCHID",$$^MSG(1476))
 I ($D(vobj(this,-100,"2*","BCHID"))&($P($E($G(vobj(this,-100,"2*","BCHID")),5,9999),$C(12))'=vobj(this,-4))) I ($L(vobj(this,-4))>12) D vRCvalidateDDerr("BCHID",$$^MSG(1076,12))
 I (vobj(this,-5)'=$ZCONVERT(vobj(this,-5),"U")) D vRCvalidateDDerr("LABEL",$$^MSG(1476))
 I ($D(vobj(this,-100,"3*","LABEL"))&($P($E($G(vobj(this,-100,"3*","LABEL")),5,9999),$C(12))'=vobj(this,-5))) I ($L(vobj(this,-5))>12) D vRCvalidateDDerr("LABEL",$$^MSG(1076,12))
 ...
 I ($D(vobj(this,-100,"0*","CODE"))&($P($E($G(vobj(this,-100,"0*","CODE")),5,9999),$C(12))'=$P(vobj(this),$C(12),1))) I ($L($P(vobj(this),$C(12),1))>255) D vRCvalidateDDerr("CODE",$$^MSG(1076,255))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL33D","MSG",979,"DBTBL33D."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey2 S oldKey2=$S($D(vobj(this,-100,"2*","BCHID")):$P($E(vobj(this,-100,"2*","BCHID"),5,9999),$C(12)),1:vobj(this,-4))
 N newKey3 S newKey3=vobj(this,-5)
 N oldKey3 S oldKey3=$S($D(vobj(this,-100,"3*","LABEL")):$P($E(vobj(this,-100,"3*","LABEL"),5,9999),$C(12)),1:vobj(this,-5))
 ...
 N oldKey4 S oldKey4=$S($D(vobj(this,-100,"4*","SEQ")):$P($E(vobj(this,-100,"4*","SEQ"),5,9999),$C(12)),1:vobj(this,-6))
  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I ($D(^DBTBL(V1,33,V2,V3,V4))#2) D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL33D(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL33D",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
