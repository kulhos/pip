 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL6F ****
 ; 
 ; 02/24/2010 18:40 - pip
 ; 
 ;
 ; Record Class code for table DBTBL6F
 ;
...
vRCgetRecord0(v1,v2,v3,vfromDbSet) ; 
 ...
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL6F",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 ;*** End of code by-passed by compiler ***
...
vRCgetRecord0Opt(v1,v2,v3,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S dbtbl6f=$G(^DBTBL(v1,6,v2,v3))
 I '(v3>100)
 E  I dbtbl6f="",'($D(^DBTBL(v1,6,v2,v3))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL6F",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl6f
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","LIBS"))&($P($E($G(vobj(this,-100,"1*","LIBS")),5,9999),$C(124))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","QRID"))&($P($E($G(vobj(this,-100,"2*","QRID")),5,9999),$C(124))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","SEQ"))&($P($E($G(vobj(this,-100,"3*","SEQ")),5,9999),$C(124))'=vobj(this,-5))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl6f,vkey1,vkey2,vkey3) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("FORMDESC,FORMDI,FORMFMT,FORMFUN,FORMIDN,FORMLF,FORMSIZE,LIBS,QRID,SEQ",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
getColumnMap(map) ; 
 ...
 S map(-4)="QRID:T:"
 S map(-3)="LIBS:T:"
 S map(-1)="FORMDESC:T:2;FORMDI:T:1;FORMFMT:T:5;FORMFUN:T:6;FORMIDN:N:3;FORMLF:N:7;FORMSIZE:N:4"
 Q 
 ;
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl6f S dbtbl6f=$$vRCgetRecord0^RecordDBTBL6F(LIBS,QRID,SEQ,0)
 .	S vobj(dbtbl6f,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL6F(dbtbl6f,$$initPar^UCUTILN(params)) K vobj(dbtbl6f,-100) S vobj(dbtbl6f,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl6f)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL6F","MSG",1767,"DBTBL6F."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 I ($L($P(vobj(this),$C(124),2))>35) D vRCvalidateDDerr("FORMDESC",$$^MSG(1076,35))
 I ($L($P(vobj(this),$C(124),1))>55) D vRCvalidateDDerr("FORMDI",$$^MSG(1076,55))
 I ($L($P(vobj(this),$C(124),5))>20) D vRCvalidateDDerr("FORMFMT",$$^MSG(1076,20))
 S X=$P(vobj(this),$C(124),6) I '(X=""),'($D(^DBCTL("SYS","QWIKFUN",X))#2) D vRCvalidateDDerr("FORMFUN",$$^MSG(1485,X))
 I '($P(vobj(this),$C(124),3)=""),'(+$P(vobj(this),$C(124),3)=$P(vobj(this),$C(124),3))  S $P(vobj(this),$C(124),3)=$$vRCtrimNumber($P(vobj(this),$C(124),3))
 S X=$P(vobj(this),$C(124),3) I '(X=""),(X'?1.3N),(X'?1"-"1.2N) D vRCvalidateDDerr("FORMIDN",$$^MSG(742,"N"))
 I '($P(vobj(this),$C(124),7)=""),'(+$P(vobj(this),$C(124),7)=$P(vobj(this),$C(124),7))  S $P(vobj(this),$C(124),7)=$$vRCtrimNumber($P(vobj(this),$C(124),7))
 S X=$P(vobj(this),$C(124),7) I '(X=""),(X'?1.2N),(X'?1"-"1.1N) D vRCvalidateDDerr("FORMLF",$$^MSG(742,"N"))
 I '($P(vobj(this),$C(124),4)=""),'(+$P(vobj(this),$C(124),4)=$P(vobj(this),$C(124),4))  S $P(vobj(this),$C(124),4)=$$vRCtrimNumber($P(vobj(this),$C(124),4))
 S X=$P(vobj(this),$C(124),4) I '(X=""),(X'?1.3N),(X'?1"-"1.2N) D vRCvalidateDDerr("FORMSIZE",$$^MSG(742,"N"))
 Q 
 ;
vRCvalidateDD1(this) ; 
 N ER S ER=0
 ...
 I ($D(vobj(this,-100,"0*","FORMDESC"))&($P($E($G(vobj(this,-100,"0*","FORMDESC")),5,9999),$C(124))'=$P(vobj(this),$C(124),2))) I ($L($P(vobj(this),$C(124),2))>35) D vRCvalidateDDerr("FORMDESC",$$^MSG(1076,35))
 I ($D(vobj(this,-100,"0*","FORMDI"))&($P($E($G(vobj(this,-100,"0*","FORMDI")),5,9999),$C(124))'=$P(vobj(this),$C(124),1))) I ($L($P(vobj(this),$C(124),1))>55) D vRCvalidateDDerr("FORMDI",$$^MSG(1076,55))
 I ($D(vobj(this,-100,"0*","FORMFMT"))&($P($E($G(vobj(this,-100,"0*","FORMFMT")),5,9999),$C(124))'=$P(vobj(this),$C(124),5))) I ($L($P(vobj(this),$C(124),5))>20) D vRCvalidateDDerr("FORMFMT",$$^MSG(1076,20))
 I ($D(vobj(this,-100,"0*","FORMFUN"))&($P($E($G(vobj(this,-100,"0*","FORMFUN")),5,9999),$C(124))'=$P(vobj(this),$C(124),6))) S X=$P(vobj(this),$C(124),6) I '(X=""),'($D(^DBCTL("SYS","QWIKFUN",X))#2) D vRCvalidateDDerr("FORMFUN",$$^MSG(1485,X))
 I ($D(vobj(this,-100,"0*","FORMIDN"))&($P($E($G(vobj(this,-100,"0*","FORMIDN")),5,9999),$C(124))'=$P(vobj(this),$C(124),3))),'($P(vobj(this),$C(124),3)=""),'(+$P(vobj(this),$C(124),3)=$P(vobj(this),$C(124),3))  S $P(vobj(this),$C(124),3)=$$vRCtrimNumber($P(vobj(this),$C(124),3))
 I ($D(vobj(this,-100,"0*","FORMIDN"))&($P($E($G(vobj(this,-100,"0*","FORMIDN")),5,9999),$C(124))'=$P(vobj(this),$C(124),3))) S X=$P(vobj(this),$C(124),3) I '(X=""),(X'?1.3N),(X'?1"-"1.2N) D vRCvalidateDDerr("FORMIDN",$$^MSG(742,"N"))
 I ($D(vobj(this,-100,"0*","FORMLF"))&($P($E($G(vobj(this,-100,"0*","FORMLF")),5,9999),$C(124))'=$P(vobj(this),$C(124),7))),'($P(vobj(this),$C(124),7)=""),'(+$P(vobj(this),$C(124),7)=$P(vobj(this),$C(124),7))  S $P(vobj(this),$C(124),7)=$$vRCtrimNumber($P(vobj(this),$C(124),7))
 I ($D(vobj(this,-100,"0*","FORMLF"))&($P($E($G(vobj(this,-100,"0*","FORMLF")),5,9999),$C(124))'=$P(vobj(this),$C(124),7))) S X=$P(vobj(this),$C(124),7) I '(X=""),(X'?1.2N),(X'?1"-"1.1N) D vRCvalidateDDerr("FORMLF",$$^MSG(742,"N"))
 I ($D(vobj(this,-100,"0*","FORMSIZE"))&($P($E($G(vobj(this,-100,"0*","FORMSIZE")),5,9999),$C(124))'=$P(vobj(this),$C(124),4))),'($P(vobj(this),$C(124),4)=""),'(+$P(vobj(this),$C(124),4)=$P(vobj(this),$C(124),4))  S $P(vobj(this),$C(124),4)=$$vRCtrimNumber($P(vobj(this),$C(124),4))
 I ($D(vobj(this,-100,"0*","FORMSIZE"))&($P($E($G(vobj(this,-100,"0*","FORMSIZE")),5,9999),$C(124))'=$P(vobj(this),$C(124),4))) S X=$P(vobj(this),$C(124),4) I '(X=""),(X'?1.3N),(X'?1"-"1.2N) D vRCvalidateDDerr("FORMSIZE",$$^MSG(742,"N"))
 Q 
 ;
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL6F","MSG",979,"DBTBL6F."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey3 S oldKey3=$S($D(vobj(this,-100,"3*","SEQ")):$P($E(vobj(this,-100,"3*","SEQ"),5,9999),$C(124)),1:vobj(this,-5))
  N V1,V2,V3 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5) I $$vDbEx5() D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL6F(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL6F",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vDbEx2() ; min(1): DISTINCT LIBS,QRID,SEQ FROM DBTBL6F WHERE LIBS=:V1 and QRID=:V2 and SEQ=:V3
 ...
 Q 1
 ;
vDbEx5() ; min(1): DISTINCT LIBS,QRID,SEQ FROM DBTBL6F WHERE LIBS=:V1 and QRID=:V2 and SEQ=:V3
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
