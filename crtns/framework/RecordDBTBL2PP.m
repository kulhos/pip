 ; 
 ; **** Routine compiled from DATA-QWIK Filer RecordDBTBL2PP ****
 ; 
 ; 02/24/2010 18:40 - pip
 ; 
 ;
 ; Record Class code for table DBTBL2PP
 ;
...
vcdmNew() ; 
 ...
 S vOid=$O(vobj(""),-1)+1,vobj(vOid,-1)="RecordDBTBL2PP",vobj(vOid,-2)=0,vobj(vOid)=""
 S vobj(vOid,-3)=""
 S vobj(vOid,-4)=""
 S vobj(vOid,-5)=""
 S vobj(vOid,-6)=""
...
vRCgetRecord0(v1,v2,v3,v4,vfromDbSet) ; 
 ...
 I vobj(vOid)="",'($D(^DBTBL(v1,2,v2,v3,v4))#2)
 S vobj(vOid,-2)=1
 I $T K vobj(vOid) S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL2PP",$EC=",U1001,"
 S vobj(vOid,-3)=v1
 S vobj(vOid,-4)=v2
 S vobj(vOid,-5)=v3
 S vobj(vOid,-6)=v4
...
vRCgetRecord0Opt(v1,v2,v3,v4,vfromDbSet,v2out) ; 
 ...
 ;  #ACCEPT DATE=02/26/2008; PGM=Dan Russell; CR=30801; Group=BYPASS
 ;*** Start of code by-passed by compiler
 S dbtbl2pp=$G(^DBTBL(v1,2,v2,v3,v4))
 I dbtbl2pp="",'($D(^DBTBL(v1,2,v2,v3,v4))#2)
 S v2out=1
 I $T S $ZE="0,"_$ZPOS_",%PSL-E-RECNOFL,,DBTBL2PP",$EC=",U1001,"
 ;*** End of code by-passed by compiler ***
 Q dbtbl2pp
 ;
...
vSave(this,vRCparams,vauditLogSeq) ; 
 ...
 .	I ($D(vobj(this,-100,"1*","LIBS"))&($P($E($G(vobj(this,-100,"1*","LIBS")),5,9999),$C(12))'=vobj(this,-3)))!($D(vobj(this,-100,"2*","SID"))&($P($E($G(vobj(this,-100,"2*","SID")),5,9999),$C(12))'=vobj(this,-4)))!($D(vobj(this,-100,"3*","SEQ"))&($P($E($G(vobj(this,-100,"3*","SEQ")),5,9999),$C(12))'=vobj(this,-5)))!($D(vobj(this,-100,"4*","PSEQ"))&($P($E($G(vobj(this,-100,"4*","PSEQ")),5,9999),$C(12))'=vobj(this,-6))) D vRCkeyChanged(this,vRCparams,.vRCaudit) Q 
...
vselectOK(this,userclass) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vselectOptmOK(userclass,dbtbl2pp,vkey1,vkey2,vkey3,vkey4) ; PUBLIC access is allowed, no restrict clause
 Q 1
 ;
vgetLogging() ; 
 Q "0"
...
vlogSelect(statement,using) ; 
 ...
 ;
columnList() ; 
 Q $$vStrRep("CODE,LIBS,PSEQ,SEQ,SID",",",$char(9),0,0,"")
 ;
columnListBM() ; 
 Q ""
 ;
...
vlegacy(processMode,params) ; 
 N vTp
 I (processMode=2) D
 .	N dbtbl2pp S dbtbl2pp=$$vRCgetRecord0^RecordDBTBL2PP(LIBS,SID,SEQ,PSEQ,0)
 .	S vobj(dbtbl2pp,-2)=2
 . S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL2PP(dbtbl2pp,$$initPar^UCUTILN(params)) K vobj(dbtbl2pp,-100) S vobj(dbtbl2pp,-2)=1 TC:vTp  
 .	K vobj(+$G(dbtbl2pp)) Q 
 Q 
 ;
vhasLiterals() ; 
...
vRCupdateDB(this,processMode,vRCparams,vRCaudit,vRCauditIns) ; 
 ...
 .	;*** Start of code by-passed by compiler
 .	if $D(vobj(this)) S ^DBTBL(vobj(this,-3),2,vobj(this,-4),vobj(this,-5),vobj(this,-6))=vobj(this)
 .	;*** End of code by-passed by compiler ***
 .	Q 
 Q 
 ;
vRCdelete(this,vRCparams,vRCaudit,isKeyChange) ; 
 ;  #ACCEPT DATE=04/22/04; PGM=Dan Russell; CR=20602; Group=BYPASS
 ;*** Start of code by-passed by compiler
 ZWI ^DBTBL(vobj(this,-3),2,vobj(this,-4),vobj(this,-5),vobj(this,-6))
 ;*** End of code by-passed by compiler ***
 Q 
 ;
vRCchkReqForInsert(this) ; 
 I (vobj(this,-3)="") D vRCrequiredErr("LIBS")
 I (vobj(this,-6)="") D vRCrequiredErr("PSEQ")
...
vRCrequiredErr(column) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL2PP","MSG",1767,"DBTBL2PP."_column)
...
vRCvalidateDD(this,processMode) ; 
 ...
 S X=vobj(this,-5) I '(X="") S errmsg=$$VAL^DBSVER("N",10,1,,,,,3) I '(errmsg="") D vRCvalidateDDerr("SEQ",$$^MSG(979,"DBTBL2PP.SEQ"_" "_errmsg))
 I '(vobj(this,-6)=""),'(+vobj(this,-6)=vobj(this,-6))  S vobj(this,-6)=$$vRCtrimNumber(vobj(this,-6))
 S X=vobj(this,-6) I '(X="") S errmsg=$$VAL^DBSVER("N",10,1,,,,,3) I '(errmsg="") D vRCvalidateDDerr("PSEQ",$$^MSG(979,"DBTBL2PP.PSEQ"_" "_errmsg))
...
vRCvalidateDD1(this) ; 
 ...
 I ($D(vobj(this,-100,"2*","SID"))&($P($E($G(vobj(this,-100,"2*","SID")),5,9999),$C(12))'=vobj(this,-4))) I ($L(vobj(this,-4))>12) D vRCvalidateDDerr("SID",$$^MSG(1076,12))
 ...
 I ($D(vobj(this,-100,"3*","SEQ"))&($P($E($G(vobj(this,-100,"3*","SEQ")),5,9999),$C(12))'=vobj(this,-5))) S X=vobj(this,-5) I '(X="") S errmsg=$$VAL^DBSVER("N",10,1,,,,,3) I '(errmsg="") D vRCvalidateDDerr("SEQ",$$^MSG(979,"DBTBL2PP.SEQ"_" "_errmsg))
 I ($D(vobj(this,-100,"4*","PSEQ"))&($P($E($G(vobj(this,-100,"4*","PSEQ")),5,9999),$C(12))'=vobj(this,-6))),'(vobj(this,-6)=""),'(+vobj(this,-6)=vobj(this,-6))  S vobj(this,-6)=$$vRCtrimNumber(vobj(this,-6))
 I ($D(vobj(this,-100,"4*","PSEQ"))&($P($E($G(vobj(this,-100,"4*","PSEQ")),5,9999),$C(12))'=vobj(this,-6))) S X=vobj(this,-6) I '(X="") S errmsg=$$VAL^DBSVER("N",10,1,,,,,3) I '(errmsg="") D vRCvalidateDDerr("PSEQ",$$^MSG(979,"DBTBL2PP.PSEQ"_" "_errmsg))
...
vRCvalidateDDerr(column,errmsg) ; 
 N ER S ER=0
 N RM S RM=""
 D SETERR^DBSEXECU("DBTBL2PP","MSG",979,"DBTBL2PP."_column_" "_errmsg)
 I ER D throwError($get(RM))
 Q 
 ;
vRCtrimNumber(str) ; 
...
vRCkeyChanged(this,vRCparams,vRCaudit) ; 
 ...
 N oldKey2 S oldKey2=$S($D(vobj(this,-100,"2*","SID")):$P($E(vobj(this,-100,"2*","SID"),5,9999),$C(12)),1:vobj(this,-4))
 ...
 N oldKey4 S oldKey4=$S($D(vobj(this,-100,"4*","PSEQ")):$P($E(vobj(this,-100,"4*","PSEQ"),5,9999),$C(12)),1:vobj(this,-6))
  N V1,V2,V3,V4 S V1=vobj(this,-3),V2=vobj(this,-4),V3=vobj(this,-5),V4=vobj(this,-6) I $$vDbEx3() D throwError($$^MSG(2327))
 ...
 S vobj(newrec,-2)=0
 S vTp=($TL=0) TS:vTp (vobj):transactionid="CS" D vSave^RecordDBTBL2PP(newrec,$$initPar^UCUTILN($$initPar^UCUTILN("/NOVAL/NOCASDEL/NOJOURNAL/NOTRIGBEF/NOTRIGAFT/"))) K vobj(newrec,-100) S vobj(newrec,-2)=1 TC:vTp  
 D
 .	N %O S %O=1
 .	N ER S ER=0
 .	N RM S RM=""
 .	;   #ACCEPT Date=10/24/2008; Pgm=RussellDS; CR=30801; Group=ACCESS
 .	D CASUPD^DBSEXECU("DBTBL2PP",oldkeys,newkeys)
 .	I ER D throwError($get(RM))
 .	Q 
  S vobj(this,-3)=oldKey1
  S vobj(this,-4)=oldKey2
...
vStrFnd(object,p1,p2,p3,qt) ; String.find
 ...
 Q p2
 ;
vDbEx1() ; min(1): DISTINCT LIBS,SID,SEQ,PSEQ FROM DBTBL2PP WHERE LIBS=:V1 and SID=:V2 and SEQ=:V3 and PSEQ=:V4
 ;
 N vsql1
 ...
 ;
 S V4=+V4
 I '($D(^DBTBL(V1,2,V2,V3,V4))#2) Q 0
 Q 1
 ;
vDbEx2() ; min(1): DISTINCT LIBS,SID,SEQ,PSEQ FROM DBTBL2PP WHERE LIBS=:V1 and SID=:V2 and SEQ=:V3 and PSEQ=:V4
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
 ...
 Q 1
 ;
vDbEx3() ; min(1): DISTINCT LIBS,SID,SEQ,PSEQ FROM DBTBL2PP WHERE LIBS=:V1 and SID=:V2 and SEQ=:V3 and PSEQ=:V4
 ;
 N vsql1
 S vsql1=$$BYTECHAR^SQLUTL(254)
 ;
 ...
 Q 1
 ;
vReCp1(v1) ; RecordDBTBL2PP.copy: DBTBL2PP
 ;
 Q $$copy^UCGMR(this)
