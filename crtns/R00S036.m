...
V0 ; External report entry point
 ...
 N rwrs,vos1,vos2,sqlcur,exe,sqlcur,vd,vi,vsql,vsub S rwrs=$$vOpen0(.exe,.vsql,"DBTBL1F.%LIBS,DBTBL1F.FID,DBTBL1F.FKEYS,DBTBL1F.TBLREF,DBTBL1F.UPD,DBTBL1F.DEL,DBTBL1F.RCTOMIN,DBTBL1F.RCTOMAX,DBTBL1F.RCFRMIN,DBTBL1F.RCFRMAX","DBTBL1F",VWHERE,"DBTBL1F.%LIBS,DBTBL1F.FID,DBTBL1F.FKEYS","","/DQMODE=1",1)
 ;  #ACCEPT Date=10/13/2008;Pgm=RussellDS;CR=35741;Group=READ
...
VHDG0 ; Page Header
 ...
 D VOM
 D VOM
 S VL=VL_$J("",(2-$L(VL)))_"(A)"
 D VOM
 S VL=VL_$J("",(0-$L(VL)))_"File Name                                   Foreign (B)                                (A)->(B)  (B)->(A)"
 D VOM
 S VL=VL_$J("",(0-$L(VL)))_"Foreign Key Reference                        Filename                     Upd  Del     Min  Max  Min  Max"
 D VOM
 S VL=VL_$J("",(2-$L(VL)))_"----------------------------------------  ------------                  ---  ---     ---  ---  ---  ---"
 D VOM
 ;
